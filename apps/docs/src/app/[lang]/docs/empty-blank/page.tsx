import { EmptyBlank, Button } from "tamga-ui";
...
export async function generateMetadata({ params }: { params: Promise<{ lang: Locale }> }) {
  ...
  return { title: findPage("empty-blank")!.title[lang] };
}
...
const T = {
  tr: {
    lead: (
      <>
        Etrafında kutu yok. Bir bölümün tamamı boşsa, o boşluğu bir kartın içine koymak boşluğa
        gereksiz bir çerçeve çizmek olur.
      </>
    ),
    kicker: "Yeni bölüm",
    title: "Buraya henüz hiç girilmedi",
    body: "Kurulumu tamamladığında bu bölüm dolmaya başlar.",
    action: "Başla",
    which: (
      <>
  ...
  en: {
    lead: (
      <>
        No box around it. When a whole section is empty, putting that emptiness inside a card only
        draws a frame around nothing.
      </>
    ),
    kicker: "New section",
    title: "Nobody has been here yet",
    body: "Once you finish setup this section starts filling up.",
    action: "Get started",
    which: (
      <>
